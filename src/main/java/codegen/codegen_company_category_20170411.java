// ORM class for table 'company_category_20170411'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat May 25 17:00:31 CST 2019
...
public class codegen_company_category_20170411 extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("company_id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        codegen_company_category_20170411.this.company_id = (Long)value;
      }
    });
    setters.put("category_code", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_company_category_20170411.this.category_code = (String)value;
      }
    });
    setters.put("status", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_company_category_20170411.this.status = (Integer)value;
      }
    });
    setters.put("updatetime", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_company_category_20170411.this.updatetime = (java.sql.Timestamp)value;
      }
    });
  }
  public codegen_company_category_20170411() {
    init0();
  }
  ...
  public codegen_company_category_20170411 with_company_id(Long company_id) {
    this.company_id = company_id;
    return this;
  }
  ...
  public codegen_company_category_20170411 with_category_code(String category_code) {
    this.category_code = category_code;
    return this;
  }
  ...
  public codegen_company_category_20170411 with_status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public codegen_company_category_20170411 with_updatetime(java.sql.Timestamp updatetime) {
    this.updatetime = updatetime;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof codegen_company_category_20170411)) {
      return false;
    }
    codegen_company_category_20170411 that = (codegen_company_category_20170411) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.company_id = JdbcWritableBridge.readLong(1, __dbResults);
    this.category_code = JdbcWritableBridge.readString(2, __dbResults);
    this.status = JdbcWritableBridge.readInteger(3, __dbResults);
    this.updatetime = JdbcWritableBridge.readTimestamp(4, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeLong(company_id, 1 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeString(category_code, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(status, 3 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeTimestamp(updatetime, 4 + __off, 93, __dbStmt);
    return 4;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    codegen_company_category_20170411 o = (codegen_company_category_20170411) super.clone();
    o.updatetime = (o.updatetime != null) ? (java.sql.Timestamp) o.updatetime.clone() : null;
    return o;
  }

  public void clone0(codegen_company_category_20170411 o) throws CloneNotSupportedException {
    o.updatetime = (o.updatetime != null) ? (java.sql.Timestamp) o.updatetime.clone() : null;
  }
