// ORM class for table 'pg_court_info'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Apr 23 22:29:34 CST 2019
...
public class codegen_pg_court_info extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        codegen_pg_court_info.this.id = (Long)value;
      }
    });
    setters.put("province", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.province = (String)value;
      }
    });
    setters.put("courtname", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.courtname = (String)value;
      }
    });
    setters.put("address", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.address = (String)value;
      }
    });
    setters.put("cityname", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.cityname = (String)value;
      }
    });
    setters.put("countyname", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.countyname = (String)value;
      }
    });
    setters.put("latitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.latitude = (String)value;
      }
    });
    setters.put("longitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.longitude = (String)value;
      }
    });
    setters.put("tel", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_pg_court_info.this.tel = (String)value;
      }
    });
  }
  public codegen_pg_court_info() {
    init0();
  }
  private Long id;
  public Long get_id() {
  ...
  public codegen_pg_court_info with_id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public codegen_pg_court_info with_province(String province) {
    this.province = province;
    return this;
  }
  ...
  public codegen_pg_court_info with_courtname(String courtname) {
    this.courtname = courtname;
    return this;
  }
  ...
  public codegen_pg_court_info with_address(String address) {
    this.address = address;
    return this;
  }
  ...
  public codegen_pg_court_info with_cityname(String cityname) {
    this.cityname = cityname;
    return this;
  }
  ...
  public codegen_pg_court_info with_countyname(String countyname) {
    this.countyname = countyname;
    return this;
  }
  ...
  public codegen_pg_court_info with_latitude(String latitude) {
    this.latitude = latitude;
    return this;
  }
  ...
  public codegen_pg_court_info with_longitude(String longitude) {
    this.longitude = longitude;
    return this;
  }
  private String tel;
  ...
  public codegen_pg_court_info with_tel(String tel) {
    this.tel = tel;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof codegen_pg_court_info)) {
      return false;
    }
    codegen_pg_court_info that = (codegen_pg_court_info) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.cityname = JdbcWritableBridge.readString(5, __dbResults);
    this.countyname = JdbcWritableBridge.readString(6, __dbResults);
    this.latitude = JdbcWritableBridge.readString(7, __dbResults);
    this.longitude = JdbcWritableBridge.readString(8, __dbResults);
    this.tel = JdbcWritableBridge.readString(9, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(cityname, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(countyname, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(latitude, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(longitude, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(tel, 9 + __off, 12, __dbStmt);
    return 9;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    codegen_pg_court_info o = (codegen_pg_court_info) super.clone();
    return o;
  }

  public void clone0(codegen_pg_court_info o) throws CloneNotSupportedException {
  }
